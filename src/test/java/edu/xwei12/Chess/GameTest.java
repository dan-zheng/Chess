 ...
 */
public class GameTest implements GameObserver<RectangleBoard, RectanglePosition> {
    StandardGame game;
    ...
    public void testStepWithMove() throws Exception {
        ...
        Assert.assertEquals(Game.State.NORMAL, game.getState());
    ...
    public void testAttack() throws Exception {
        ...
        Assert.assertTrue(p.getKind().equals(DefaultPiece.PAWN.getKind()) && p.getTag() == StandardGame.PLAYER_A);
        Assert.assertEquals(15, board.getPiecesByKind(DefaultPiece.PAWN.getKind()).size());
    ...
    public void testCheckmate() throws Exception {
        ...
        Assert.assertEquals(Game.State.CHECKMATE, game.getState());
